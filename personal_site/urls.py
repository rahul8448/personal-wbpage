...
urlpatterns = patterns('',
    ...
    url(r'^msg_board/search$', 'message_dashboard.views.searchDB_view'),
    url(r'^getmessage$', 'message_dashboard.views.get_messages'),
    url(r'^msg_board/searchmessage$', 'message_dashboard.views.search_messages'),
    url(r'^msg_board/deletemessage$', 'message_dashboard.views.update_isRead'),
